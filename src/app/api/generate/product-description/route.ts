...
import { createProductDescriptionPrompt } from "@/lib/prompts";
...
export async function POST(req: Request) {
  ...
  const parsedRequest = productDescriptionRequestSchema.safeParse(
  ...
  const result = streamText({
    ...
    `,
    prompt: createProductDescriptionPrompt(parsedRequest.data),
